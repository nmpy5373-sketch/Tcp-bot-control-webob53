...
def bot_control():
    ...
    if action == 'start':
        ...
        try:
            with open("SAMI.txt", "w") as f: f.write(f"uid={uid}\npassword={pw}")
...
def proxy_guild():
    ...
    base_url = "https://jubayer-guild-info.vercel.app"
    urls = {
        'info': f"{base_url}/info?clan_id={gid}&region={reg}",
